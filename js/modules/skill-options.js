...
Object.assign(P12_OPTIONS, {
    ...
    'shapes_early:compose_shapes': [
        ...
        { id: 'shapes', label: 'The shape made', type: 'set', default: [0, 1, 2], group: 'difficulty',
            ...
            allLabel: 'All of them, mixed',
            help: 'The kindergarten shapes are ticked: triangles, squares, rectangles and hexagons. Pentagons, trapezoids, rhombuses and half circles are grade 1: tick them for a harder page.' },
        ...
        { id: 'count', label: 'Names to choose from', type: 'enum', default: 2, group: 'difficulty',
            ...
            help: 'Two names to choose from is the start; three is harder. One wrong name is often the name of a piece.',
...
Object.assign(P12_OPTIONS, {
    'area_perimeter:perimeter_intro': [_p12Max([16, 24, 60, 100], 40, { label: 'Perimeter up to', labels: { null: 'Up to 40 (sides to 10)' },
        help: 'The largest perimeter on the page. Up to 16 keeps to small shapes and a 5- or 6-sided shape needs 24 or more; 60 and 100 bring longer sides (to 15 and to 25).' })],
...
[
    ...
    // Build lane geometry (2026-09-25): the area and perimeter figures (shape-grid kind `figure`,
    // gen-geo-kit.js). "Some" leaves off the sides the pupil works out from the equal sides
    // opposite them (a rectangle's second length and width; the matching side of an L, T or U).
    ['area_perimeter:perimeter', _ap2Labels(['all', 'some'], 'all', _AP2_SIDES,
        'Some labels one length and one width; the pupil knows the opposite sides are equal. The missing-side items always show the sides they need.'),
    levelSubset([3, 2, 1], 1, 'Level 3 writes the answer in grey to trace; level 2 adds the formula line and, on a story, a labelled sketch; level 1 is the figure alone.')],
    ['area_perimeter:area', _ap2Labels(['all', 'some'], 'all', _AP2_SIDES,
        'Some labels one length and one width; the pupil knows the opposite sides are equal. The missing-side items always show the sides they need.'),
    levelSubset([3, 2, 1], 1, 'Level 3 writes the answer in grey to trace; level 2 adds the formula line and, on a story, a labelled sketch; level 1 is the figure alone.')],
    ['area_perimeter:area_perimeter', _ap2Labels(['all', 'some'], 'all', _AP2_SIDES,
        'Some labels one length and one width; the pupil knows the opposite sides are equal.'),
    levelSubset([3, 2, 1], 1, 'Level 3 writes both answers in grey to trace; level 2 adds the formula line; level 1 is the figure alone.')],
    ['area_perimeter:composite_shapes', _ap2Labels(['all', 'some'], 'all',
        { all: 'Every side labelled', some: 'Two sides left for the pupil to work out' },
        'Some leaves off two sides the pupil works out from the sides opposite them (the harder step, 6.G.1).'),
    levelSubset([3, 2, 1], 1, 'Level 3 writes the answer in grey to trace; level 2 adds the formula line and the dotted split into rectangles; level 1 is the figure alone.')],
    ['area_perimeter:area_polygon_decompose', _ap2Labels(['all', 'some'], 'all',
        { all: 'Every side labelled', some: 'Two sides left for the pupil to work out' },
        'Some leaves off two sides the pupil works out from the sides opposite them.'),
    levelSubset([3, 2, 1], 1, 'Level 3 writes the answer in grey to trace; level 2 draws the dotted line that splits the shape into rectangles; level 1 leaves the split to the pupil.')],
    ...
    ['area_perimeter:perimeter_intro',
        { id: 'shapes', label: 'Which shapes', type: 'set', default: [0, 1, 2], group: 'difficulty',
            values: [{ v: 0, l: 'Rectangles and squares (4 sides)' }, { v: 1, l: 'Triangles (3 sides)' },
                { v: 2, l: 'Shapes with 5 or 6 sides' }],
            allLabel: 'All three, mixed',
    ...
    ['area_perimeter:area_triangle',
        { id: 'shapes', label: 'Which triangles', type: 'set', default: [0, 1, 2], group: 'difficulty',
            values: [{ v: 0, l: 'Right triangles (the height is a side)' }, { v: 1, l: 'Acute triangles (the height inside)' },
                { v: 2, l: 'Obtuse triangles (the height outside)' }],
            allLabel: 'All three, mixed',
            help: 'Right triangles come first: the height is a side. An obtuse triangle\'s height falls outside it, on the base drawn longer.' },
