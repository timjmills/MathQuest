...
import { itemKey, casesOf } from '../lesson-rules.js';
...
const keyOfItem = (it) => itemKey((it && it.q && it.q.text) || '', it && it.q ? it.q.ans : '', it && it.q && it.q.cell && it.q.cell.payload ? it.q.cell.payload.n : undefined);
