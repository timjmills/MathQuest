...
export const SKILL_STANDARDS = {
    ...
    // ---- counting
    'counting:count_objects': { ccss: ['K.CC.B.5', 'K.CC.B.4b'], ee: ['M.EE.K.CC.6', 'M.EE.K.CC.4', 'M.EE.2.NBT.2'] }, // Count Objects (1-20) (Visual)
    'counting:count_sequence': { ccss: ['K.CC.A.2', 'K.CC.B.4c'], ee: ['M.EE.K.CC.4', 'M.EE.1.NBT.1', 'M.EE.K.CC.1'] }, // Next/Before/After Number (Visual)
    'counting:number_seq_fill': { ccss: ['1.NBT.A.1', 'K.CC.A.2'], ee: ['M.EE.1.NBT.1', 'M.EE.2.NBT.3'] }, // Number Sequence: Fill Missing (Grid)
    'counting:mixed_counting': { ccss: [], ee: [], pool: true }, // Mixed Counting

    // ---- comparing
    'comparing:compare_groups': { ccss: ['K.CC.C.6'], ee: ['M.EE.K.CC.7', 'M.EE.1.NBT.3', 'M.EE.2.NBT.4'] }, // More/Fewer/Same Groups (Visual)
    'comparing:compare_objects': { ccss: ['K.MD.A.2', 'K.MD.A.1'], ee: ['M.EE.K.MD.2', 'M.EE.K.MD.1'] }, // Compare Attributes (Visual)
    ...
    'composing:base10_regroup': { ccss: ['2.NBT.A.1a', '1.NBT.B.2a'], ee: ['M.EE.2.NBT.1', 'M.EE.1.NBT.2'] }, // Regroup with Base-10 Blocks
    ...
    // ---- addition
    'addition:add_facts': { ccss: ['1.OA.C.6', '2.OA.B.2'], ee: ['M.EE.2.NBT.7', 'M.EE.3.OA.6'] }, // Addition Facts (within 20)
    ...
    'addition:add_sub_fact_family': { ccss: ['1.OA.B.4', '1.OA.B.3'], ee: [] }, // Addition Fact Families
    ...
    'addition:add_5_pictures': { ccss: ['K.OA.A.5', 'K.OA.A.1'], ee: ['M.EE.K.OA.1', 'M.EE.1.OA.1', 'M.EE.2.NBT.7'] }, // Add Within 5 with Pictures (Visual)
    ...
    'addition:add_wp_10': { ccss: ['K.OA.A.2'], ee: ['M.EE.2.NBT.7', 'M.EE.3.OA.6', 'M.EE.3.OA.7'] }, // Addition Word Problems (within 10)
    ...
    'addition:add_wp_100': { ccss: ['2.OA.A.1'], ee: ['M.EE.3.OA.7'] }, // Addition Word Problems (within 100)
    ...
    // ---- subtraction
    'subtraction:sub_facts': { ccss: ['1.OA.C.6', '2.OA.B.2'], ee: ['M.EE.2.NBT.7', 'M.EE.3.OA.6'] }, // Subtraction Facts (within 20)
    ...
    'subtraction:sub_wp_100': { ccss: ['2.OA.A.1'], ee: ['M.EE.3.OA.7'] }, // Subtraction Word Problems (within 100)
    ...
    // ---- multiplication
    'multiplication:mult_facts': { ccss: ['3.OA.C.7'], ee: ['M.EE.3.OA.6'] }, // Multiplication Facts (1-12)
    'multiplication:multiply': { ccss: ['3.OA.C.7', '4.NBT.B.5'], ee: ['M.EE.3.OA.6'] }, // Basic Multiplication
    'multiplication:arrays_groups': { ccss: ['2.OA.C.4', '3.OA.A.1'], ee: ['M.EE.2.OA.4', 'M.EE.3.OA.1'] }, // Arrays & Equal Groups (Visual)
    'multiplication:dot_array_mult': { ccss: ['2.OA.C.4', '3.OA.A.1'], ee: ['M.EE.2.OA.4', 'M.EE.3.OA.1'] }, // Dot Array Multiplication (B&W)
    ...
    'multiplication:repeated_add_to_mult': { ccss: ['2.OA.C.4', '3.OA.A.1'], ee: ['M.EE.2.OA.4', 'M.EE.3.OA.1'] }, // Write Repeated Addition as Multiplication (Visual)
    ...
    'division:div_word_problems': { ccss: ['3.OA.A.3', '3.OA.A.2'], ee: ['M.EE.3.OA.2'] }, // Division Word Problems
    ...
    'division:share_into_groups': { ccss: ['3.OA.A.2'], ee: ['M.EE.3.OA.2'] }, // Make Equal Groups to Divide (Visual)
    ...
    // ---- integers
    'integers:number_line_int': { ccss: ['6.NS.C.6c', '6.NS.C.5'], ee: ['M.EE.6.NS.6', 'M.EE.6.NS.5'] }, // Number Lines with Negatives
    ...
    'number_ops_mixed:word_problems_mixed': { ccss: ['3.OA.D.8', '4.OA.A.3'], ee: ['M.EE.3.OA.7', 'M.EE.4.OA.3'] }, // Mixed Word Problems (+−×÷) (Visual)
    'number_ops_mixed:word_problems_mixed_plain': { ccss: ['3.OA.D.8', '4.OA.A.3'], ee: ['M.EE.3.OA.7', 'M.EE.4.OA.3'] }, // Mixed Word Problems (+−×÷) (No Pictures)
    ...
    'number_ops_mixed:which_sign': { ccss: ['1.OA.D.7', '3.OA.A.4'], ee: ['M.EE.1.OA.7'] }, // Which Sign Makes It True? (+ − × ÷)
    'number_ops_mixed:missing_factor_or_addend': { ccss: ['1.OA.D.8', '3.OA.A.4'], ee: [] }, // Missing Addend or Missing Factor?

    // ---- fractions
    'fractions:identify': { ccss: ['3.NF.A.1', '3.G.A.2'], ee: ['M.EE.3.NF.1', 'M.EE.3.G.2', 'M.EE.4.NF.1', 'M.EE.5.NF.1'] }, // Identify Fractions (Visual)
    'fractions:write_fraction': { ccss: ['3.NF.A.1'], ee: ['M.EE.3.NF.1'] }, // Write the Fraction Shown
    'fractions:shade_fraction': { ccss: ['3.NF.A.1'], ee: ['M.EE.3.NF.1'] }, // Shade the Fraction
    'fractions:equiv_frac_visual': { ccss: ['3.NF.A.3a', '3.NF.A.3b'], ee: ['M.EE.3.NF.3'] }, // Equivalent Fractions (Visual)
    ...
    'fractions:compare': { ccss: ['4.NF.A.2', '3.NF.A.3d'], ee: ['M.EE.4.NF.2', 'M.EE.3.NF.3'] }, // Compare Fractions (>, <, =)
    ...
    'fraction_operations:frac_mult_word': { ccss: ['5.NF.B.6', '5.NF.B.7c'], ee: [] }, // Fraction Mult/Div Word Problems (Visual)
    ...
    // ---- decimals
    'decimals:add_decimal': { ccss: ['5.NBT.B.7'], ee: ['M.EE.5.NBT.7'] }, // Adding Decimals
    'decimals:sub_decimal': { ccss: ['5.NBT.B.7'], ee: ['M.EE.5.NBT.7'] }, // Subtracting Decimals
    'decimals:mult_decimal': { ccss: ['5.NBT.B.7'], ee: ['M.EE.5.NBT.7'] }, // Multiplying Decimals
    ...
    // ---- shapes_early
    'shapes_early:name_2d_shapes': { ccss: ['K.G.A.2'], ee: ['M.EE.K.G.2', 'M.EE.2.G.1', 'M.EE.3.G.1'] }, // Identify 2D Shapes (Visual)
    ...
    'shapes_early:count_sides_vertices_2d': { ccss: ['2.G.A.1', 'K.G.B.4'], ee: ['M.EE.2.G.1'] }, // Count Sides & Vertices on 2D Shape (Visual)
    'shapes_early:order_objects_length': { ccss: ['1.MD.A.1'], ee: ['M.EE.1.MD.1'] }, // Order Objects by Length (Visual)
    'shapes_early:measure_nonstandard': { ccss: ['1.MD.A.2'], ee: ['M.EE.1.MD.2'] }, // Measure with Non-Standard Units (Visual)
    'shapes_early:compose_shapes': { ccss: ['K.G.B.6', '1.G.A.2'], ee: ['M.EE.1.G.2'] }, // Combine Shapes (Visual)
    'shapes_early:compose_hexagon': { ccss: ['1.G.A.2'], ee: ['M.EE.1.G.2'] }, // Compose a Hexagon from Pattern Blocks
    'shapes_early:compose_rect_from_squares': { ccss: ['2.G.A.2'], ee: [] }, // Compose a Rectangle from Squares
    'shapes_early:partition_shapes': { ccss: ['1.G.A.3', '2.G.A.3'], ee: ['M.EE.1.G.3'] }, // Halves/Thirds/Fourths (Visual)
    'shapes_early:shape_attributes': { ccss: ['1.G.A.1'], ee: ['M.EE.1.G.1'] }, // Shapes by Attributes (Visual)
    'shapes_early:compose_from_attributes': { ccss: ['1.G.A.1', '2.G.A.1'], ee: ['M.EE.1.G.1', 'M.EE.2.G.1'] }, // Find Shapes by Attributes (Multi-Select)
    ...
    'area_perimeter:area_unit_squares': { ccss: ['3.MD.C.6', '3.MD.C.5b'], ee: ['M.EE.4.MD.3'] }, // Area - Unit Square Counting (Visual)
    ...
    'area_perimeter:volume_composite': { ccss: ['5.MD.C.5c'], ee: ['M.EE.5.MD.5'] }, // Composite 3D Volume (Visual)
    'area_perimeter:mixed_area_perimeter': { ccss: [], ee: [], pool: true }, // Mixed Area & Perimeter

    // ---- angles_lines
    'angles_lines:identify_angles': { ccss: ['4.G.A.1'], ee: ['M.EE.4.G.1'] }, // Identify Angles
    ...
    // ---- shapes_classify
    'shapes_classify:classify_triangles': { ccss: ['4.G.A.2'], ee: ['M.EE.4.G.2'] }, // Classify Triangles
    'shapes_classify:classify_quads': { ccss: ['5.G.B.4', '5.G.B.3'], ee: ['M.EE.5.G.4', 'M.EE.5.G.3'] }, // Classify Quadrilaterals
    ...
    // ---- coordinates
    'coordinates:coordinate_q1': { ccss: ['5.G.A.1'], ee: ['M.EE.5.G.1'] }, // Coordinates (Quadrant I)
    'coordinates:coordinate_all': { ccss: ['6.NS.C.6c', '6.NS.C.6b'], ee: ['M.EE.6.NS.6'] }, // Coordinates (All 4 Quadrants)
    ...
    'measurement:mass_volume_liquid': { ccss: ['3.MD.A.2'], ee: ['M.EE.3.MD.2'] }, // Grams, kg, Liters (Visual)
    ...
    // ---- graphs
    'graphs:bar_graph': { ccss: ['3.MD.B.3'], ee: ['M.EE.3.MD.3', 'M.EE.2.MD.10', 'M.EE.4.MD.4'] }, // Bar Graphs
    'graphs:build_bar_graph': { ccss: ['3.MD.B.3', '2.MD.D.10'], ee: ['M.EE.3.MD.3', 'M.EE.2.MD.10'] }, // Build a Bar Graph
    'graphs:pictograph': { ccss: ['3.MD.B.3'], ee: ['M.EE.3.MD.3', 'M.EE.2.MD.10', 'M.EE.4.MD.4'] }, // Pictographs
    'graphs:build_pictograph': { ccss: ['2.MD.D.10'], ee: ['M.EE.2.MD.10'] }, // Build a Pictograph
    'graphs:tally_chart': { ccss: ['1.MD.C.4'], ee: ['M.EE.1.MD.4'] }, // Tally Charts
    'graphs:line_plot': { ccss: ['3.MD.B.4', '2.MD.D.9'], ee: ['M.EE.3.MD.4', 'M.EE.2.MD.9'] }, // Line Plots
    'graphs:line_plot_g2': { ccss: ['2.MD.D.9'], ee: ['M.EE.2.MD.9'] }, // Line Plots (Grade 2)
    ...
    'data_analysis:histogram_read': { ccss: ['6.SP.B.4'], ee: ['M.EE.6.SP.4'] }, // Read a Histogram (Visual)
    ...
    'algebra:tape_diagram_plain': { ccss: ['4.OA.A.3', '3.OA.D.8'], ee: ['M.EE.4.OA.3', 'M.EE.3.OA.7'] }, // Tape Diagrams (No Pictures)
    'algebra:multi_step_word': { ccss: ['4.OA.A.3', '3.OA.D.8'], ee: ['M.EE.4.OA.3', 'M.EE.3.OA.7'] }, // Multi-Step Word Problems (Visual)
    'algebra:multi_step_word_plain': { ccss: ['4.OA.A.3', '3.OA.D.8'], ee: ['M.EE.4.OA.3', 'M.EE.3.OA.7'] }, // Multi-Step Word Problems (No Pictures)
    ...
    'algebra:inequalities': { ccss: ['6.EE.B.8', '6.EE.B.5'], ee: ['M.EE.6.EE.5-7'] }, // Inequalities (>, <, ≥, ≤)
    ...
    'algebra:solve_eq_multdiv': { ccss: ['6.EE.B.7'], ee: ['M.EE.6.EE.5-7'] }, // Solve One-Step Equations (×/÷)
    ...
    'order_of_operations:compare_expressions': { ccss: ['5.OA.A.2', '5.OA.A.1'], ee: [] }, // Compare Expressions (=, ≠, <, >)
    ...
    'number_sense:estimate_sums_diffs': { ccss: ['3.NBT.A.1', '3.OA.D.8'], ee: ['M.EE.3.NBT.1', 'M.EE.3.OA.7'] }, // Estimate Sums & Differences
