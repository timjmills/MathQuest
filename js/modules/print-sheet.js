...
import { renderCell, cellAnswerKey, cellFootprint, resolveCtx, SIZES, INSTRUCTION_LIBRARY, getProvider, cellMinSize, sizeFloor, WORKSHEET_LOOK, LESSON_LOOK } from './sheet/index.js';
...
function hostItem(g, sectionIndex, size, { supports: withSupports = true, mix = null, look = WORKSHEET_LOOK } = {}) {
    ...
    try { fp = cellFootprint(qFoot, resolveCtx({ mode: 'print', size: floor, look })); } catch (e) { fp = { wMm: 93, hMm: null, measure: true, maxCols: 2 }; }
    if (legacy) {
