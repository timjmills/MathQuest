...
export const SKILL_GRADES = {
    ...
    'estimate_frac_ops': 5,
    // Compose-fraction-tiles widget skills (drag unit fractions to fill target)
    'compose_whole': 3, 'compose_target_frac': 4,
    // Decimals (new skills)
    'order_decimals': 5,
    // Conversions
    ...
    // Compose-shape-blocks widget skills (drag pattern blocks into target outline)
    'compose_hexagon': 1, 'compose_rect_from_squares': 2,
    // Geometry
    ...
    'time_quarter': 2, 'time_5min': 2, 'time_1min': 3,
    'time_analog_digital': 2, 'time_match_clock': 2,
    // P10 (ruling Q13): ordering clocks is grade 1-2 work (analog 1, digital 2).
    'order_clocks_analog_asc': 1, 'order_clocks_analog_desc': 1,
    'order_clocks_digital_asc': 2, 'order_clocks_digital_desc': 2,
    // P10 appends
    'clock_parts': 1, 'time_fives_ring': 2, 'time_sense': 2, 'elapsed_find_start': 3,
    'coin_value': 1, 'money_notation': 2, 'money_change': 3, 'money_compare': 2,
    'reading_ruler': 2, 'money_count': 2, 'money': 2,
    'equiv_coin_sets': 2, 'enough_money': 2, 'make_change_least_coins': 3,
    ...
    // Math Vocabulary (per-grade × per-domain variants)
    'vocab_grade_K_operations': 'K', 'vocab_grade_K_counting': 'K', 'vocab_grade_K_geometry': 'K',
    'vocab_grade_K_data': 'K', 'vocab_grade_K_algebra': 'K', 'vocab_grade_K_measurement': 'K',
    'vocab_grade_1_operations': 1, 'vocab_grade_1_counting': 1, 'vocab_grade_1_geometry': 1,
    'vocab_grade_1_data': 1, 'vocab_grade_1_algebra': 1, 'vocab_grade_1_measurement': 1,
    'vocab_grade_2_operations': 2, 'vocab_grade_2_counting': 2, 'vocab_grade_2_fractions': 2,
    'vocab_grade_2_geometry': 2, 'vocab_grade_2_data': 2, 'vocab_grade_2_algebra': 2,
    'vocab_grade_2_measurement': 2,
    'vocab_grade_3_operations': 3, 'vocab_grade_3_fractions': 3, 'vocab_grade_3_geometry': 3,
    'vocab_grade_3_data': 3, 'vocab_grade_3_algebra': 3, 'vocab_grade_3_measurement': 3,
    'vocab_grade_4_operations': 4, 'vocab_grade_4_fractions': 4, 'vocab_grade_4_geometry': 4,
    'vocab_grade_4_data': 4, 'vocab_grade_4_algebra': 4, 'vocab_grade_4_measurement': 4,
    'vocab_grade_5_operations': 5, 'vocab_grade_5_fractions': 5, 'vocab_grade_5_geometry': 5,
    'vocab_grade_5_data': 5, 'vocab_grade_5_algebra': 5, 'vocab_grade_5_measurement': 5,
    'vocab_grade_6_operations': 6, 'vocab_grade_6_fractions': 6, 'vocab_grade_6_geometry': 6,
    'vocab_grade_6_data': 6, 'vocab_grade_6_algebra': 6, 'vocab_grade_6_measurement': 6,
};
...
export const SKILLS = {
    ...
    counting: [
        ...
        { v: "match_same", l: "Match the Same" },
        { v: "ordinal_numbers", l: "1st, 2nd, 3rd" },
    ],
    comparing: [
    ...
    composing: [
        ...
        { v: "ten_frame_build", l: "Build a Number on a Ten Frame" },
        { v: "ten_frame_build_teen", l: "Build a Teen Number on Two Ten Frames" },
        { v: "base10_build", l: "Build a Number with Base-10 Blocks" },
        { v: "base10_regroup", l: "Regroup with Base-10 Blocks" },
        { v: "base10_build_hundreds", l: "Build 3-Digit Numbers with Flats" },
        { v: "odd_even", l: "Odd or Even? (Visual)" },
        // Label, not id: renaming a label moves nothing, so no share code is affected.
        // "Click" is a screen word and this label reaches paper (BD-12, and the owner's ruling
        // that Check replaces Tick everywhere a pupil reads). The page now names the pencil action.
        { v: "select_even_odd", l: "Circle the Even or Odd Numbers (MAP)" },
    ...
    integers: [
        ...
        { v: "order_negatives", l: "Order Integers: Least to Greatest" },
        { v: "integer_nl_drag", l: "Place Integers on a Number Line" },
    ...
    fractions: [
        ...
        { v: "select_equiv_frac", l: "Circle the Equivalent Fractions (MAP)" },
        ...
        { v: "compose_target_frac", l: "Compose a Target Fraction" },
        ...
        { v: "order_fractions", l: "Order Fractions" },
    ...
    decimals: [
        ...
        { v: "order_decimals", l: "Order Decimals" },
        { v: "decimal_nl_drag", l: "Place Decimals on a Number Line" },
    ...
    shapes_early: [
        ...
        { v: "shape_name_match_2d", l: "Match Names to 2D Shapes" },
        { v: "shape_name_match_3d", l: "Match Names to 3D Shapes" },
        ...
        { v: "compose_hexagon", l: "Compose a Hexagon from Pattern Blocks" },
        { v: "compose_rect_from_squares", l: "Compose a Rectangle from Squares" },
    ...
    shapes_classify: [
        ...
        { v: "hotspot_quads", l: "Circle the Quadrilaterals" },
    ...
    measurement: [
        ...
        { v: "time_analog_digital", l: "Analog and Digital Time" },
        { v: "time_match_clock", l: "Find the Clock for a Time" },
        // Order Clocks (drag chronologically)
        { v: "order_clocks_analog_asc", l: "Put Clocks in Order, Earliest First" },
        { v: "order_clocks_analog_desc", l: "Put Clocks in Order, Latest First" },
        { v: "order_clocks_digital_asc", l: "Put Digital Times in Order, Earliest First" },
        { v: "order_clocks_digital_desc", l: "Put Digital Times in Order, Latest First" },
        // Elapsed Time Skills
        { v: "elapsed_30min", l: "30 Minutes Later or Earlier" },
        { v: "elapsed_hour", l: "Hours Later or Earlier" },
        { v: "elapsed_15min", l: "15, 30, 45 Minutes Later or Earlier" },
        { v: "elapsed_mixed", l: "Hours and Minutes Later" },
        { v: "elapsed_find_duration", l: "How Long From Start to End?" },
        // Visual Elapsed Time (two clocks shown)
        { v: "elapsed_visual_easy", l: "Time Between Two Clocks (30 Minutes)" },
        { v: "elapsed_visual_medium", l: "Time Between Two Clocks (15 Minutes)" },
        { v: "elapsed_visual_hard", l: "Time Between Two Clocks (5 Minutes)" },
        // Other Measurement
        ...
        { v: "money_count", l: "Count Coins and Notes" },
        { v: "money", l: "Add Money" },
        { v: "equiv_coin_sets", l: "Do the Coins Make the Amount?" },
        { v: "enough_money", l: "Is There Enough Money?" },
        { v: "make_change_least_coins", l: "Make an Amount With the Fewest Coins" },
        ...
        // P10 appends, 2026-09-25 (design/research/time-money.md §18). APPEND ONLY, never reorder.
        { v: "clock_parts", l: "Parts of a Clock" },
        { v: "time_fives_ring", l: "Count the Minutes by Fives" },
        { v: "time_sense", l: "a.m. or p.m.?" },
        { v: "elapsed_find_start", l: "Find the Start Time" },
        { v: "coin_value", l: "Coins and Notes by Value" },
        { v: "money_notation", l: "Write an Amount of Money" },
        { v: "money_change", l: "Find the Change" },
        { v: "money_compare", l: "Which Has More Money?" },
    ],
    geo_mixed: [
    ...
    graphs: [
        ...
        { v: "build_bar_graph", l: "Build a Bar Graph" },
        { v: "pictograph", l: "Pictographs" },
        { v: "build_pictograph", l: "Build a Pictograph" },
    ...
    algebra: [
        ...
        { v: "build_expr_addsub", l: "Build the Expression: +/−" },
        { v: "build_expr_multdiv", l: "Build the Expression: ×/÷" },
    ...
    placevalue: [
        { v: "more_less_10", l: "1 More, 1 Less, 10 More, 10 Less" },
        { v: "more_less_100", l: "10 More, 10 Less, 100 More, 100 Less" },
        { v: "place_value_disks", l: "Read Place-Value Disks" },
        { v: "pv_disks_build", l: "Draw Place-Value Disks for a Number" },
        { v: "pv_digit_drag", l: "Write the Digits in a Place-Value Chart" },
        { v: "number_word_names", l: "Choose the Word Name" },
        { v: "place_value_10x", l: "Multiply and Divide by 10, 100, 1,000" },
    ...
    number_sense: [
        ...
        { v: "round_sort_10", l: "Rounding Sort: Nearest 10" },
        { v: "round_sort_100", l: "Rounding Sort: Nearest 100" },
        { v: "round_sort_1000", l: "Rounding Sort: Nearest 1,000" },
        { v: "round_sort_10000", l: "Rounding Sort: Nearest 10,000" },
        { v: "round_sort_100000", l: "Rounding Sort: Nearest 100,000" },
        { v: "round_sort_million", l: "Rounding Sort: Nearest 1,000,000" },
        { v: "round_sort_tenths", l: "Rounding Sort: Nearest Tenth" },
        { v: "round_sort_hundredths", l: "Rounding Sort: Nearest Hundredth" },
        ...
        // Owner request 2026-09-25 (round on number lines to the thousands and beyond) — APPEND ONLY.
    ...
    vocabulary: [
        ...
        // Per-grade-AND-per-domain variants (43 total). Pools are filtered
        // by grade + domain in gen-vocabulary.js. Skipped combos: K/fractions,
        // 1/fractions, 3/counting, 4/counting, 5/counting, 6/counting (<3 cards).
        { v: "vocab_grade_K_operations",  l: "Math Vocabulary – Kindergarten: Operations (Match)" },
        { v: "vocab_grade_K_counting",    l: "Math Vocabulary – Kindergarten: Counting (Match)" },
        { v: "vocab_grade_K_geometry",    l: "Math Vocabulary – Kindergarten: Geometry (Match)" },
        { v: "vocab_grade_K_data",        l: "Math Vocabulary – Kindergarten: Data (Match)" },
        { v: "vocab_grade_K_algebra",     l: "Math Vocabulary – Kindergarten: Algebra (Match)" },
        { v: "vocab_grade_K_measurement", l: "Math Vocabulary – Kindergarten: Measurement (Match)" },
        { v: "vocab_grade_1_operations",  l: "Math Vocabulary – Grade 1: Operations (Match)" },
        { v: "vocab_grade_1_counting",    l: "Math Vocabulary – Grade 1: Counting (Match)" },
        { v: "vocab_grade_1_geometry",    l: "Math Vocabulary – Grade 1: Geometry (Match)" },
        { v: "vocab_grade_1_data",        l: "Math Vocabulary – Grade 1: Data (Match)" },
        { v: "vocab_grade_1_algebra",     l: "Math Vocabulary – Grade 1: Algebra (Match)" },
        { v: "vocab_grade_1_measurement", l: "Math Vocabulary – Grade 1: Measurement (Match)" },
        { v: "vocab_grade_2_operations",  l: "Math Vocabulary – Grade 2: Operations (Match)" },
        { v: "vocab_grade_2_counting",    l: "Math Vocabulary – Grade 2: Counting (Match)" },
        { v: "vocab_grade_2_fractions",   l: "Math Vocabulary – Grade 2: Fractions (Match)" },
        { v: "vocab_grade_2_geometry",    l: "Math Vocabulary – Grade 2: Geometry (Match)" },
        { v: "vocab_grade_2_data",        l: "Math Vocabulary – Grade 2: Data (Match)" },
        { v: "vocab_grade_2_algebra",     l: "Math Vocabulary – Grade 2: Algebra (Match)" },
        { v: "vocab_grade_2_measurement", l: "Math Vocabulary – Grade 2: Measurement (Match)" },
        { v: "vocab_grade_3_operations",  l: "Math Vocabulary – Grade 3: Operations (Match)" },
        { v: "vocab_grade_3_fractions",   l: "Math Vocabulary – Grade 3: Fractions (Match)" },
        { v: "vocab_grade_3_geometry",    l: "Math Vocabulary – Grade 3: Geometry (Match)" },
        { v: "vocab_grade_3_data",        l: "Math Vocabulary – Grade 3: Data (Match)" },
        { v: "vocab_grade_3_algebra",     l: "Math Vocabulary – Grade 3: Algebra (Match)" },
        { v: "vocab_grade_3_measurement", l: "Math Vocabulary – Grade 3: Measurement (Match)" },
        { v: "vocab_grade_4_operations",  l: "Math Vocabulary – Grade 4: Operations (Match)" },
        { v: "vocab_grade_4_fractions",   l: "Math Vocabulary – Grade 4: Fractions (Match)" },
        { v: "vocab_grade_4_geometry",    l: "Math Vocabulary – Grade 4: Geometry (Match)" },
        { v: "vocab_grade_4_data",        l: "Math Vocabulary – Grade 4: Data (Match)" },
        { v: "vocab_grade_4_algebra",     l: "Math Vocabulary – Grade 4: Algebra (Match)" },
        { v: "vocab_grade_4_measurement", l: "Math Vocabulary – Grade 4: Measurement (Match)" },
        { v: "vocab_grade_5_operations",  l: "Math Vocabulary – Grade 5: Operations (Match)" },
        { v: "vocab_grade_5_fractions",   l: "Math Vocabulary – Grade 5: Fractions (Match)" },
        { v: "vocab_grade_5_geometry",    l: "Math Vocabulary – Grade 5: Geometry (Match)" },
        { v: "vocab_grade_5_data",        l: "Math Vocabulary – Grade 5: Data (Match)" },
        { v: "vocab_grade_5_algebra",     l: "Math Vocabulary – Grade 5: Algebra (Match)" },
        { v: "vocab_grade_5_measurement", l: "Math Vocabulary – Grade 5: Measurement (Match)" },
        { v: "vocab_grade_6_operations",  l: "Math Vocabulary – Grade 6: Operations (Match)" },
        { v: "vocab_grade_6_fractions",   l: "Math Vocabulary – Grade 6: Fractions (Match)" },
        { v: "vocab_grade_6_geometry",    l: "Math Vocabulary – Grade 6: Geometry (Match)" },
        { v: "vocab_grade_6_data",        l: "Math Vocabulary – Grade 6: Data (Match)" },
        { v: "vocab_grade_6_algebra",     l: "Math Vocabulary – Grade 6: Algebra (Match)" },
        { v: "vocab_grade_6_measurement", l: "Math Vocabulary – Grade 6: Measurement (Match)" },
    ],
};
...
export const SKILL_TIME_CATEGORY = {
    ...
    zero_none: "quick", ordinal_numbers: "quick", what_can_we_measure: "quick", compare_capacity: "quick", match_same: "quick", odd_one_out: "quick", compare_size: "quick",
    ...
    compose_whole: "extended", compose_target_frac: "extended",
    compose_hexagon: "extended", compose_rect_from_squares: "extended",
    // Measurement
    ...
    // P10 appends
    clock_parts: "quick", time_fives_ring: "quick", time_sense: "quick", elapsed_find_start: "extended",
    coin_value: "quick", money_notation: "quick", money_change: "extended", money_compare: "quick",
    ...
    // Math Vocabulary (per-grade × per-domain variants)
    vocab_grade_K_operations: "extended", vocab_grade_K_counting: "extended",
    vocab_grade_K_geometry: "extended", vocab_grade_K_data: "extended",
    vocab_grade_K_algebra: "extended", vocab_grade_K_measurement: "extended",
    vocab_grade_1_operations: "extended", vocab_grade_1_counting: "extended",
    vocab_grade_1_geometry: "extended", vocab_grade_1_data: "extended",
    vocab_grade_1_algebra: "extended", vocab_grade_1_measurement: "extended",
    vocab_grade_2_operations: "extended", vocab_grade_2_counting: "extended",
    vocab_grade_2_fractions: "extended", vocab_grade_2_geometry: "extended",
    vocab_grade_2_data: "extended", vocab_grade_2_algebra: "extended",
    vocab_grade_2_measurement: "extended",
    vocab_grade_3_operations: "extended", vocab_grade_3_fractions: "extended",
    vocab_grade_3_geometry: "extended", vocab_grade_3_data: "extended",
    vocab_grade_3_algebra: "extended", vocab_grade_3_measurement: "extended",
    vocab_grade_4_operations: "extended", vocab_grade_4_fractions: "extended",
    vocab_grade_4_geometry: "extended", vocab_grade_4_data: "extended",
    vocab_grade_4_algebra: "extended", vocab_grade_4_measurement: "extended",
    vocab_grade_5_operations: "extended", vocab_grade_5_fractions: "extended",
    vocab_grade_5_geometry: "extended", vocab_grade_5_data: "extended",
    vocab_grade_5_algebra: "extended", vocab_grade_5_measurement: "extended",
    vocab_grade_6_operations: "extended", vocab_grade_6_fractions: "extended",
    vocab_grade_6_geometry: "extended", vocab_grade_6_data: "extended",
    vocab_grade_6_algebra: "extended", vocab_grade_6_measurement: "extended",
...
export const SKILL_PRINT_SIZE = {
    ...
    // Build lane k2 (2026-09-25)
    zero_none: "compact", ordinal_numbers: "wide", what_can_we_measure: "compact", compare_capacity: "compact", match_same: "compact", odd_one_out: "compact", compare_size: "compact",
    ...
    equiv_coin_sets: "medium", enough_money: "medium", make_change_least_coins: "medium",
    ...
    // P10 appends (the kit cell is what prints; these keep the legacy path whole)
    clock_parts: "medium", time_fives_ring: "medium", time_sense: "standard", elapsed_find_start: "wide",
    coin_value: "wide", money_notation: "medium", money_change: "standard", money_compare: "wide",
    ...
    rounding_visual: "wide", place_value_disks: "wide", pv_disks_build: "wide",
    ...
    vocab_grade_6: "wide",
    // Math Vocabulary (per-grade × per-domain variants — same wide layout)
    vocab_grade_K_operations: "wide", vocab_grade_K_counting: "wide",
    vocab_grade_K_geometry: "wide", vocab_grade_K_data: "wide",
    vocab_grade_K_algebra: "wide", vocab_grade_K_measurement: "wide",
    vocab_grade_1_operations: "wide", vocab_grade_1_counting: "wide",
    vocab_grade_1_geometry: "wide", vocab_grade_1_data: "wide",
    vocab_grade_1_algebra: "wide", vocab_grade_1_measurement: "wide",
    vocab_grade_2_operations: "wide", vocab_grade_2_counting: "wide",
    vocab_grade_2_fractions: "wide", vocab_grade_2_geometry: "wide",
    vocab_grade_2_data: "wide", vocab_grade_2_algebra: "wide",
    vocab_grade_2_measurement: "wide",
    vocab_grade_3_operations: "wide", vocab_grade_3_fractions: "wide",
    vocab_grade_3_geometry: "wide", vocab_grade_3_data: "wide",
    vocab_grade_3_algebra: "wide", vocab_grade_3_measurement: "wide",
    vocab_grade_4_operations: "wide", vocab_grade_4_fractions: "wide",
    vocab_grade_4_geometry: "wide", vocab_grade_4_data: "wide",
    vocab_grade_4_algebra: "wide", vocab_grade_4_measurement: "wide",
    vocab_grade_5_operations: "wide", vocab_grade_5_fractions: "wide",
    vocab_grade_5_geometry: "wide", vocab_grade_5_data: "wide",
    vocab_grade_5_algebra: "wide", vocab_grade_5_measurement: "wide",
    vocab_grade_6_operations: "wide", vocab_grade_6_fractions: "wide",
    vocab_grade_6_geometry: "wide", vocab_grade_6_data: "wide",
    vocab_grade_6_algebra: "wide", vocab_grade_6_measurement: "wide",
};
...
export const PRINT_FORMAT_SIZE = {
    ...
    'pv-disks-build': 'wide', 'pv-cell': 'medium',
...
export const CALCULATOR_SKILLS = new Set([
    ...
    // Order of operations — calc on for ALL OoO skills (per user spec).
    'oop_easy',
    'oop_medium',
    'oop_hard',
    'paren_simple',
...
export const RIT_BAND_SKILLS_K2 = {
    ...
    '141-150': ['count_objects','count_sequence','compare_groups','compare_objects','classify_count',
                ...
                'ten_frame_build',
                'vocab_grade_K',
                'vocab_grade_K_operations','vocab_grade_K_counting','vocab_grade_K_geometry',
                'vocab_grade_K_data','vocab_grade_K_algebra','vocab_grade_K_measurement'],
    ...
    '151-160': ['number_bonds','make_ten',
                ...
                'vocab_grade_K_operations','vocab_grade_K_counting','vocab_grade_K_geometry',
                'vocab_grade_K_data','vocab_grade_K_algebra','vocab_grade_K_measurement',
                'vocab_grade_1_operations','vocab_grade_1_counting','vocab_grade_1_geometry',
                'vocab_grade_1_data','vocab_grade_1_algebra','vocab_grade_1_measurement'],
    ...
    '161-170': ['add_facts','sub_facts','add_20_mixed','sub_20_mixed','missing_add_sub','equal_sign',
                ...
                'vocab_grade_1_operations','vocab_grade_1_counting','vocab_grade_1_geometry',
                'vocab_grade_1_data','vocab_grade_1_algebra','vocab_grade_1_measurement',
                'vocab_grade_2_operations','vocab_grade_2_counting','vocab_grade_2_fractions',
                'vocab_grade_2_geometry','vocab_grade_2_data','vocab_grade_2_algebra',
    ...
    '181-190': ['mult_facts','multiply','arrays_groups','mult_div_fact_family','number_families_mult',
                ...
                'mult_chart_easy',
                'vocab_grade_3',
                'vocab_grade_3_operations','vocab_grade_3_fractions','vocab_grade_3_geometry',
                'vocab_grade_3_data','vocab_grade_3_algebra','vocab_grade_3_measurement'],
    ...
    '191-200': ['mult_chart','nl_mult','mult_word_problems_plain','multi_step_word_plain',
                ...
                'build_expr_addsub',
                'make_change_least_coins',
                'mult_chart_easy','mult_chart_medium',
                'vocab_grade_3','vocab_grade_4',
                'vocab_grade_3_operations','vocab_grade_3_fractions','vocab_grade_3_geometry',
                'vocab_grade_3_data','vocab_grade_3_algebra','vocab_grade_3_measurement',
                'vocab_grade_4_operations','vocab_grade_4_fractions','vocab_grade_4_geometry',
                'vocab_grade_4_data','vocab_grade_4_algebra','vocab_grade_4_measurement'],
    ...
    '201-210': ['div_facts','divide','missing_mult_div','number_families_mult_med',
                ...
                'mult_chart_medium','mult_chart_hard',
                'vocab_grade_4','vocab_grade_5',
                'vocab_grade_4_operations','vocab_grade_4_fractions','vocab_grade_4_geometry',
                'vocab_grade_4_data','vocab_grade_4_algebra','vocab_grade_4_measurement',
                'vocab_grade_5_operations','vocab_grade_5_fractions','vocab_grade_5_geometry',
                'vocab_grade_5_data','vocab_grade_5_algebra','vocab_grade_5_measurement'],
    ...
    '211-220': ['add_fractions_like','sub_fractions_like',
                ...
                'vocab_grade_5_operations','vocab_grade_5_fractions','vocab_grade_5_geometry',
                'vocab_grade_5_data','vocab_grade_5_algebra','vocab_grade_5_measurement',
                'vocab_grade_6_operations','vocab_grade_6_fractions','vocab_grade_6_geometry',
                'vocab_grade_6_data','vocab_grade_6_algebra','vocab_grade_6_measurement'],
};
...
export const RIT_BAND_SKILLS_35 = {
    ...
    '221-230': ['exponents_simple','solve_eq_addsub','solve_eq_multdiv','solve_eq_twostep',
                ...
                'compare_int','add_int','sub_int','integer_nl_drag','tape_diagram',
