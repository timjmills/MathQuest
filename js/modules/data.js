...
export const SKILL_GRADES = {
    ...
    'count_through_zero': 4, 'share_and_group_early': 'K', 'add_sub_patterns': 2, 'long_multiplication': 5,
    // Fraction Operations
...
export const SKILLS = {
    ...
    multiplication: [
        ...
        { v: "long_multiplication", l: "Long Multiplication and Short Division" },
    ],
    division: [
...
export const SKILL_PRINT_SIZE = {
    ...
    add_int: "standard", sub_int: "standard", number_line_int: "standard", count_through_zero: "wide", share_and_group_early: "medium", add_sub_patterns: "medium", long_multiplication: "medium",
