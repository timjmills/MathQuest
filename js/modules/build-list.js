...
export const STANDARD_PROPOSALS = {
    ...
    whole_frac_reverse: P({
        ...
        misconceptions: ['6/1 = 1/6', '4/4 = 4'], wrmSteps: ['Y3.B6.S8'],
    }),
    frac_same_whole: P({
...
export const VISUAL_AFTER = {
    ...
    frac_compare_gt1: ['vis_frac_bar_modes'], mult_mixed_int: ['vis_frac_bar_modes'], sub_break_whole: ['vis_frac_bar_modes'],
