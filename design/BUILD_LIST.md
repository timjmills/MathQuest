...
|---|---|---|---|---|---|---|---|---|---|
| Counting and early number (K-1 pictures) (`k2`) | 31 | 12 | 7 | 0 | 12 | 20 | 29 | 51 | 450 |
...
| `picture-row` | `k2` | a row or small grid of line-drawn pictures with letter tags: match, odd one out, order events, repeating patterns | 12 entries |
...
## Lane `k2`: Counting and early number (K-1 pictures) (31)
...
Your existing entries that also draw catalogued representations (build them with these pictures): `sort_groups` (V059); `capacity_early` (V121); `systematic_bonds` (V112); `subitise` (V102, V135); `ten_count_out` (V101); `tens_ones_group` (V116); `teen_structure` (V103); `ordinal` (V123).

### 20. Picture Task Kinds (one more, order, which, match, pairs) — `vis_k2_picture_tasks`
...
### 21. Part-Whole Options (parts, values, pictures, open, chains) — `vis_bond_options`
...
### 22. Read a Base-10 Picture (template option) — `vis_base10_read`
...
### 23. New Picture Kinds: Cubes, Bundles, Number Shapes, Rods, Dominoes — `vis_object_kinds`
...
### 24. Ten-Frame Options (units, frames, fills, five frame) — `vis_tenframe_options`
...
### 25. Sort Tables, Venn and Carroll Diagrams — `vis_sort_diagrams`
...
### 26. Number Tracks With Fractions, Decimals, Words and Pictures — `vis_count_row_values`
...
### 27. Bead String and Hundred-Bead Rekenrek — `vis_bead_panes`
...
### 28. Hidden Part (cover mark) — `vis_cover_mark`
...
### 29. Shade the Hundred Square (whole-chart tasks) — `vis_chart_shade`
...
### 30. First – Then – Now Story Strip — `vis_story_strip`
...
### 31. Hands-On Card and Game Pages (low) — `vis_k2_hands_on`
