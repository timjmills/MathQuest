...
- 270 entries: **127 new skills, 88 new options, 2 repairs**, and **53 added from the visual catalogue** (1 wiring, 10 template, 6 pane, 28 option, 1 skill, 6 migration, 1 band).
- 157 from the White Rose audit (41 extended for standards), 60 from the standards audit.
...
|---|---|---|---|---|---|---|---|---|---|
| Counting and early number (K-1 pictures) (`k2`) | 30 | 11 | 7 | 0 | 12 | 19 | 23 | 50 | 444 |
...
## Lane `k2`: Counting and early number (K-1 pictures) (30)
...
### 2. Number Bonds in Order — `systematic_bonds`
...
### 3. Say How Many Without Counting — `subitise`
...
### 4. Count Out a Number — `ten_count_out`
...
### 5. Count in a Circle and to 30 (option) — `count_objects_more`
...
### 6. Count by Making Tens — `tens_ones_group`
...
### 7. Number Sense Review — `consolidate`
...
### 9. Count to 120 on the Chart (option) — `chart_120`
...
### 10. Same Number After Moving (option) — `count_conserve`
...
### 11. How Many Hundreds? (option) — `hundreds_foundation`
...
### 12. What Can We Measure? — `measurable_attributes`
...
### 13. Write the Number Sentence for the Picture (option) — `pictures_to_sentence`
...
### 14. A Hundred Is Ten Tens (option) — `regroup_hundreds`
...
### 15. Understand 10 and 20 (option) — `teen_structure`
...
### 16. Write the Numbers 0 to 20 — `write_numerals`
...
### 17. Number Bonds to 20 — `bonds_20`
...
### 19. Picture Task Kinds (one more, order, which, match, pairs) — `vis_k2_picture_tasks`
...
### 20. Part-Whole Options (parts, values, pictures, open, chains) — `vis_bond_options`
...
### 21. Read a Base-10 Picture (template option) — `vis_base10_read`
...
### 22. New Picture Kinds: Cubes, Bundles, Number Shapes, Rods, Dominoes — `vis_object_kinds`
...
### 23. Ten-Frame Options (units, frames, fills, five frame) — `vis_tenframe_options`
...
### 24. Sort Tables, Venn and Carroll Diagrams — `vis_sort_diagrams`
...
### 25. Number Tracks With Fractions, Decimals, Words and Pictures — `vis_count_row_values`
...
### 26. Bead String and Hundred-Bead Rekenrek — `vis_bead_panes`
...
### 27. Hidden Part (cover mark) — `vis_cover_mark`
...
### 28. Shade the Hundred Square (whole-chart tasks) — `vis_chart_shade`
...
### 29. First – Then – Now Story Strip — `vis_story_strip`
...
### 30. Hands-On Card and Game Pages (low) — `vis_k2_hands_on`
