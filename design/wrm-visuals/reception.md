...
| R04 | Sorting rings / hoops ("yes / not", by attribute, 0 / not 0, 4 sides / not) | B1 S4–S6; B4 S1; B5 S1; B6 S1, S4; B7 S2; B10 S1; B11 S1; B15 S8 | MATCH | `template:sort-rings` + `comparing:sort_into_groups` (kind / shape / size / heavy-light rings, sort and count, the rule found); `classify_count` counts one kind (build lane k2) |
