...
- **PT-FRM-8 (owner ruling 2026-09-26).** Every printed paper carries the copyright line "© <year> Cultivating the Digital. All rights reserved." On kit sheets, keys and lessons it hangs just below the footer band in the bottom margin (6.5 pt, black, centred), so the band never grows and the body keeps its height; the legacy print path and the Quiz Builder's printed test carry it in their running page footer. The year is the print year.
