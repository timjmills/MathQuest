// FIXTURE - the share-code option decoder as DEPLOYED (origin/master at 1d56f9d), copied verbatim
// from js/modules/skill-option-codec.js at that commit; only its import path is changed.
// tests/scripts/ws-codec-registry.mjs runs it against codes the new encoder writes, to prove that a
// copy of the app that has not updated skips the digit + letter keys and never misreads them.
// NEVER EDIT the code below: it stands for copies of the app already out in the world.
...
import { optionsFor, normalizeOptions, packOptions } from '../../js/modules/skill-options.js';
