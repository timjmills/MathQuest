        ...
        for (const s of skills) for (const role of kitRoles) {
            ...
            try {
                ...
                if (source === 'legacy') {
                    ...
                    }, { s, seed, COUNT: parseInt(arg('count', '6'), 10), role, ANCHORS: arg('anchors', 'off'), SUPPORTS: arg('supports', null), COVER: arg('cover', null), MIX: arg('mix', null), OPTS: arg('opts', null) ? JSON.parse(arg('opts', '{}')) : null });
